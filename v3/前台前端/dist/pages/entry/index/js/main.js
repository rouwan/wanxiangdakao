...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_f_loat_mpvue_loader_lib_template_compiler_index_id_data_v_188bc383_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_node_modules_f_loat_mpvue_loader_lib_selector_type_template_index_0_index_vue__ = __webpack_require__(161);
var disposed = false
...
/* scopeId */
var __vue_scopeId__ = "data-v-188bc383"
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_f_loat_mpvue_loader_lib_template_compiler_index_id_data_v_188bc383_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_node_modules_f_loat_mpvue_loader_lib_selector_type_template_index_0_index_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-188bc383", Component.options)
  } else {
    hotAPI.reload("data-v-188bc383", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_extends___default()({}, Object(__WEBPACK_IMPORTED_MODULE_6_vuex__["b" /* mapMutations */])({
    ...
    getMusicSetting: function getMusicSetting() {
      // 音频已注释，直接跳过
      try {
        wx.setStorageSync('musicObj[bg]', true);
      } catch (e) {}
      try {
        wx.setStorageSync('musicObj[sound]', true);
      } catch (e) {}
    },
    ...
    getDevice: function getDevice() {
      ...
      wx.getSystemInfo({
        success: function success(res) {
          _this5.store.commit("setDeviceInfo", {
    ...
    login: function login() {
      ...
      return new __WEBPACK_IMPORTED_MODULE_2_babel_runtime_core_js_promise___default.a(function (resolve, reject) {
        ...
        var doLogin = function doLogin(code) {
          _this6.fly.get("/login", { code: code }).then(function (res) {
            if (res.data.Tag == 1) {
              _this6.setSessionId(res.data.SessionId);
              _this6.setSecretCode(res.data.Result.code);
              _this6.setOpenId(res.data.Result.openId);
              wx.hideLoading();
              _this6.getInit();
              _this6.getAllModuleType();
              _this6.getDevice();
              console.log("登录成功");
        ...
        if (_this6.store.state.EVN === 'Dev') {
          doLogin('dev_test_01');
        } else {
          wx.login({
            success: function success(res) {
              return doLogin(res.code);
            },
            fail: function fail() {
              return reject();
            }
        ...
        success: function success(res) {
          ...
          if (t1) {
            ...
            if (t2 - t1.time >= 20000) {
              console.log("试玩成功");
              // 试玩成功
              _this7.showAdBox = true;
              var t = setTimeout(function () {
                _this7.setTryGameName(t1.name);
                _this7.tryGameName = t1.name;
                clearTimeout(t);
              }, 500);
            } else {
              console.log("失败");
    ...
    setMusic: function setMusic(volume, state, type) {
      // 音频已注释
      try {
        wx.setStorageSync("musicObj[" + type + "]", state);
      } catch (e) {}
    },
    ...
    getInit: function getInit() {
      ...
      this.fly.post("/init", {
        ...
        _this8.seasonData = res.data.Result.seasonEnd;
        if (_this8.seasonData && _this8.seasonData.paragraph) {
          _this8.showSeason = true;
        }
        _this8.setAppInfo(res.data.Result);
        _this8.initTimer = setTimeout(function () {
          _this8.initPage();
        }, 500);

        // 显示每日福利
        if (_this8.appInfo.isDaySign == 1) {
          _this8.showDayGfit = true;
        }

        _this8.setDayCount(res.data.Result.dayCardNumber);
        _this8.setLotteryList(res.data.Result.prizeList);
        _this8.expStyle = "width:" + _this8.appInfo.expValue / _this8.appInfo.maxExpValue * 100 + "%;";
        wx.getStorage({
          key: "themeSet",
          success: function success(res) {
            _this8.setGamePageType(res.data);
          }
        });
      });
    },
    ...
    updateUserInfo: function updateUserInfo(event) {
      ...
      this.fly.post("/authorize", {
        ...
        _this9.appInfo.nickName = data.nickName;
        _this9.appInfo.avatarUrl = data.avatarUrl;
        _this9.appInfo.gender = data.gender;
        _this9.appInfo.city = data.city;
        _this9.appInfo.province = data.province;
        _this9.appInfo.country = data.country;

        _this9.setIsUpdateUserInfo(true);
        wx.setStorage({
          key: "day",
    ...
    battleClickHandle: function battleClickHandle() {
      ...
      this.apiClickRoom().then(function (res) {
        if (res == 0) {
          _this11.$router.push("/pages/battleRoom/index");
        }
      });
    },
    ...
    getnewFoodCard: function getnewFoodCard() {
      ...
      wx.getStorage({
        key: "newFoodCard",
        success: function success(res) {
          _this12.newFoodCard = res.data;
        },
        fail: function fail() {
          _this12.newFoodCard = 0;
        }
      });
    },
    ...
    getRoomId: function getRoomId() {
      ...
      return new __WEBPACK_IMPORTED_MODULE_2_babel_runtime_core_js_promise___default.a(function (resolve, reject) {
        _this13.fly.post("/room/getRoomId").then(function (res) {
          _this13.setRoomId({ roomId: res.data.Result.code }); //顺便设置缓存
    ...
    apiClickRoom: function apiClickRoom() {
      ...
      return new __WEBPACK_IMPORTED_MODULE_2_babel_runtime_core_js_promise___default.a(function (resolve, reject) {
        _this14.fly.post("/room/clickRoom", { code: _this14.roomId }).then(function (res) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_f_loat_mpvue_loader_lib_template_compiler_index_id_data_v_3f469826_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_node_modules_f_loat_mpvue_loader_lib_selector_type_template_index_0_seasonModal_vue__ = __webpack_require__(130);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-3f469826"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_f_loat_mpvue_loader_lib_template_compiler_index_id_data_v_3f469826_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_node_modules_f_loat_mpvue_loader_lib_selector_type_template_index_0_seasonModal_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-3f469826", Component.options)
  } else {
    hotAPI.reload("data-v-3f469826", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-3f469826", esExports)
  }
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_f_loat_mpvue_loader_lib_template_compiler_index_id_data_v_149c9684_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_node_modules_f_loat_mpvue_loader_lib_selector_type_template_index_0_day_gift_vue__ = __webpack_require__(138);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-149c9684"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_f_loat_mpvue_loader_lib_template_compiler_index_id_data_v_149c9684_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_node_modules_f_loat_mpvue_loader_lib_selector_type_template_index_0_day_gift_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-149c9684", Component.options)
  } else {
    hotAPI.reload("data-v-149c9684", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_f_loat_mpvue_loader_lib_template_compiler_index_id_data_v_576eb0fb_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_node_modules_f_loat_mpvue_loader_lib_selector_type_template_index_0_catGame_vue__ = __webpack_require__(137);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-576eb0fb"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_f_loat_mpvue_loader_lib_template_compiler_index_id_data_v_576eb0fb_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_node_modules_f_loat_mpvue_loader_lib_selector_type_template_index_0_catGame_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-576eb0fb", Component.options)
  } else {
    hotAPI.reload("data-v-576eb0fb", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-576eb0fb", esExports)
  }
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-149c9684", esExports)
  }
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-7303f754", esExports)
  }
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_f_loat_mpvue_loader_lib_template_compiler_index_id_data_v_5a4065ae_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_node_modules_f_loat_mpvue_loader_lib_selector_type_template_index_0_menu_vue__ = __webpack_require__(157);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-5a4065ae"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_f_loat_mpvue_loader_lib_template_compiler_index_id_data_v_5a4065ae_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_node_modules_f_loat_mpvue_loader_lib_selector_type_template_index_0_menu_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-5a4065ae", Component.options)
  } else {
    hotAPI.reload("data-v-5a4065ae", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, Object(__WEBPACK_IMPORTED_MODULE_1_vuex__["b" /* mapMutations */])(["setMusic", "setHasTipLottery"]), {
    ...
    setMusic: function setMusic(volume, state, type) {
      if (type == "bg") {
        if (this.globalBgPlayer) this.globalBgPlayer.volume = volume;
      } else if (type == "sound") {
        if (this.globalSoundPlayer) this.globalSoundPlayer.volume = volume;
      }
      if (volume != 0 && type == "bg" && this.globalBgPlayer) {
        this.globalBgPlayer.volume = 0.5;
      }
      if (state && type == "bg" && this.globalBgPlayer) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_f_loat_mpvue_loader_lib_template_compiler_index_id_data_v_519d95d1_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_node_modules_f_loat_mpvue_loader_lib_selector_type_template_index_0_settingModal_vue__ = __webpack_require__(148);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-519d95d1"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_f_loat_mpvue_loader_lib_template_compiler_index_id_data_v_519d95d1_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_node_modules_f_loat_mpvue_loader_lib_selector_type_template_index_0_settingModal_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-519d95d1", Component.options)
  } else {
    hotAPI.reload("data-v-519d95d1", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-519d95d1", esExports)
  }
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_f_loat_mpvue_loader_lib_template_compiler_index_id_data_v_12f462a0_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_node_modules_f_loat_mpvue_loader_lib_selector_type_template_index_0_packModal_vue__ = __webpack_require__(156);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-12f462a0"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_f_loat_mpvue_loader_lib_template_compiler_index_id_data_v_12f462a0_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_node_modules_f_loat_mpvue_loader_lib_selector_type_template_index_0_packModal_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-12f462a0", Component.options)
  } else {
    hotAPI.reload("data-v-12f462a0", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_f_loat_mpvue_loader_lib_template_compiler_index_id_data_v_74905daa_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_node_modules_f_loat_mpvue_loader_lib_selector_type_template_index_0_gift_box_vue__ = __webpack_require__(155);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-74905daa"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_f_loat_mpvue_loader_lib_template_compiler_index_id_data_v_74905daa_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_node_modules_f_loat_mpvue_loader_lib_selector_type_template_index_0_gift_box_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-74905daa", Component.options)
  } else {
    hotAPI.reload("data-v-74905daa", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-74905daa", esExports)
  }
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-12f462a0", esExports)
  }
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-5a4065ae", esExports)
  }
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-188bc383", esExports)
  }
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_f_loat_mpvue_loader_lib_template_compiler_index_id_data_v_7303f754_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_node_modules_f_loat_mpvue_loader_lib_selector_type_template_index_0_invateBox_vue__ = __webpack_require__(141);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-7303f754"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_f_loat_mpvue_loader_lib_template_compiler_index_id_data_v_7303f754_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_node_modules_f_loat_mpvue_loader_lib_selector_type_template_index_0_invateBox_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7303f754", Component.options)
  } else {
    hotAPI.reload("data-v-7303f754", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
