    ...
    <el-table
      ...
      <el-table-column
       ...
       <el-table-column
        ...
        label="图片">
        <template slot-scope="scope"> 
          <img :src="GLOBALUploadSourceURL+scope.row.image" alt=""  :preview="pageIndex" :preview-text="scope.row.smallName" style="width: 50px;height: 50px">
         </template> 
      </el-table-column>
       <el-table-column
        prop="sortId"
...
<script>
  ...
  import AddModules from './weekTitleAdd'
  import UpdateModules from './weekTitleUpdate' 
      ...
      deleteHandle(id){
         this.$confirm('此操作将永久删除该数据, 是否继续?', '提示', {
          ...
          type: 'warning'
           ...
           this.$http({
              url: this.$http.adornUrl('/smallVientianeTest/weekTitle/delete'),
              method: 'get',
