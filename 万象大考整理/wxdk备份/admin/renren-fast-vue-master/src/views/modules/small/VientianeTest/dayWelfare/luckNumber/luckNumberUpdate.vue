  ...
  <el-dialog
    ...
    <el-form :model="basicData" :rules="dataRule" ref="basicData" label-width="100px">
      ...
      <el-form-item label="描述" prop="description">
       ...
       <el-form-item label="排序" prop="value" style="margin-top: 45px;">
        <el-input-number v-model="basicData.sortId" controls-position="right" :min="0" label="排序" style="margin-left: 15px;border:0px; "></el-input-number>   
      </el-form-item> 
    </el-form>
     ...
     init (id) {
          ...
          this.initGoodsType().then((resolve)=>{
            this.$nextTick(() => {            
              ...
              if (this.basicData.id) {
                this.$http({
                  url: this.$http.adornUrl(`/smallVientianeTest/luckNumber/getLuckNumberById`),
                  method: "get",
                  ...
                  if (data && data.Tag === 1) {
                    ...
                    this.basicData.number = data.Result.number;
      ...
      dataFormSubmit () {
        ...
        if(valid){     
          ...
          var thiz = this;
          this.$http({
            url: this.$http.adornUrl('/smallVientianeTest/luckNumber/update'),
            method: 'post',
            data: {
