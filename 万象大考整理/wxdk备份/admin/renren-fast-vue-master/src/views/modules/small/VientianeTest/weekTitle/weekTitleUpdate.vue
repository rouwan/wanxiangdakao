    ...
    methods: {
        ...
        if(id == "img[preview]"){return ;}
          ...
          this.$nextTick(() => {
            ...
            if (this.basicData.id) {
              this.$http({
                url: this.$http.adornUrl(`/smallVientianeTest/weekTitle/getWeekTitleById`),
                method: "get",
                ...
                if (data && data.Tag === 1) {
                  ...
                  this.basicData.bigName = data.Result.bigName;
                  this.basicData.smallName = data.Result.smallName;
      ...
      dataFormSubmit () {
        ...
        if(valid){     
          ...
          var thiz = this;
          this.$http({
            url: this.$http.adornUrl('/smallVientianeTest/weekTitle/update'),
            method: 'post',
            data: {
              id: id,
              bigName: bigName,
