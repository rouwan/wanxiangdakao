...
<script>
  ...
  import AddModules from './luckNumberAdd'
  import UpdateModules from './luckNumberUpdate' 
  ...
  export default {
    ...
    methods: {
      ...
      deleteHandle(id){
         this.$confirm('此操作将永久删除该数据, 是否继续?', '提示', {
          ...
          type: 'warning'
           ...
           this.$http({
              url: this.$http.adornUrl('/smallVientianeTest/luckNumber/delete'),
              method: 'get',
      ...
      getDataList (type) {
        ...
        this.$http({
          url: this.$http.adornUrl('/smallVientianeTest/luckNumber/getPageList'),
          method: 'get',
          params: this.$http.adornParams({
