    ...
    methods: {
      init (id) {
        ...
        this.$nextTick(() => {
          ...
          if (this.basicData.id) {
            this.$http({
              url: this.$http.adornUrl(`/smallVientianeTest/robotAction/getRobotActionById`),
              method: "get",
              ...
              if (data && data.Tag === 1) {
                ...
                this.basicData.answerTime = data.Result.answerTime;
      ...
      dataFormSubmit () {                
        ...
        if(valid){     
          ...
          var thiz = this;
          this.$http({
            url: this.$http.adornUrl('/smallVientianeTest/robotAction/update'),
            method: 'post',
            data: {
              id: id,
              type: type,
