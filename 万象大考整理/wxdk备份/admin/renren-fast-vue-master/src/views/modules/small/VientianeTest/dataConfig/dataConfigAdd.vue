  ...
  <el-dialog
    ...
    <el-form :model="dataConfig" :rules="dataRule" ref="dataConfig"  label-width="100px">
        <el-form-item label="键/值" prop="value">
            <el-input v-model="dataConfig.name" :value="dataConfig.name" class="title-input" style=" border:0px;width: 230px;"></el-input>
            ->
      ...
      <el-form-item label="是否下发手机" >
         <el-checkbox-group v-model="dataConfig.type">
           <el-checkbox :checked="dataConfig.type"></el-checkbox>
        </el-checkbox-group>
      </el-form-item>
    </el-form>
    ...
    methods: {
      ...
      dataFormSubmit () {
        ...
        this.$refs['dataConfig'].validate((valid) => {
          ...
          var thiz = this;
          this.$http({
            url: this.$http.adornUrl('/smallVientianeTest/dataConfig/add'),
            method: 'post',
            data: {
