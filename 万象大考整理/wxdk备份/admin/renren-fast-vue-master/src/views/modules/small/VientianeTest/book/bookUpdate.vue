    ...
    <el-form :model="basicData" :rules="dataRule" ref="basicData" label-width="100px">
      <el-form-item label="类型" prop="type" >  
       ...
       <el-form-item label="名称" prop="remark">
        <el-input class="title-input" v-model="basicData.remark"  :value="basicData.remark" style=" border:0px; width:220px;"></el-input>
      </el-form-item>
      ...
      <el-form-item label="序号" prop="type" >  
        <el-input-number  v-model="basicData.sortId" controls-position="right" :min="0" label="序号" style="margin-left: 15px;border:0px; "></el-input-number>            
      </el-form-item>
    </el-form>
  ...
  export default {
    ...
    methods: {
      init (id) {
        if(id == "img[preview]"){return ;}
          ...
          this.$nextTick(() => {
            ...
            if (this.basicData.id) {
              this.$http({
                url: this.$http.adornUrl(`/smallVientianeTest/book/getBookById`),
                method: "get",
                ...
                if (data && data.Tag === 1) {
                  ...
                  this.basicData.remark = data.Result.remark;
        ...
        this.reqImageUrl = this.$http.adornUrl(`/smallVientianeTest/book/uploadImage?token=${this.$cookie.get("token")}`);
        this.visible = true;
      },
       // 上传之前
      ...
      dataFormSubmit () {
        ...
        if(valid){     
          ...
          var thiz = this;
          this.$http({
            url: this.$http.adornUrl('/smallVientianeTest/book/update'),
            method: 'post',
            data: {
              id: this.basicData.id,
              type: this.basicData.type,
              remark: this.basicData.remark,
