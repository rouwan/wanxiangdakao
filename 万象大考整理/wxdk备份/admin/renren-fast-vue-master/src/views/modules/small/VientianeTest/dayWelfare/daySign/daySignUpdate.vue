  ...
  <el-dialog
    ...
    <el-form :model="basicData" :rules="dataRule" ref="basicData" label-width="100px">
      <el-form-item label="第几天"> 
        <el-select  v-model="basicData.day" placeholder="请选择" clearable style="margin-left: 15px;">            
            <el-option key="1" label="第一天" value="1" ></el-option>
            <el-option key="2" label="第二天" value="2"  ></el-option>
            <el-option key="3" label="第三天" value="3" ></el-option>
            <el-option key="4" label="第四天" value="4"  ></el-option>
            <el-option key="5" label="第五天" value="5"  ></el-option>
            <el-option key="6" label="第六天" value="6"  ></el-option>
            <el-option key="7" label="第七天" value="7"  ></el-option>           
        </el-select> 
        </el-form-item>
     ...
     init (id) {
          ...
          this.initGoodsType().then((resolve)=>{
            this.$nextTick(() => {            
              ...
              if (this.basicData.id) {
                this.$http({
                  url: this.$http.adornUrl(`/smallVientianeTest/daySign/getDaySignById`),
                  method: "get",
                  ...
                  if (data && data.Tag === 1) {
                    ...
                    this.basicData.day = data.Result.day.toString();
                    ...
                    this.basicData.isLookNum = data.Result.isLookNum == 1 ? true : false;
      ...
      dataFormSubmit () {
        ...
        if(valid){     
          ...
          var thiz = this;
          this.$http({
            url: this.$http.adornUrl('/smallVientianeTest/daySign/update'),
            method: 'post',
            data: {
              id: this.basicData.id,
              day: this.basicData.day,           
