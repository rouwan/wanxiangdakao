<template>
  <el-dialog
    ...
    <el-form :model="basicData" :rules="dataRule" ref="subject" label-width="100px">
        ...
        <!-- <el-form-item label="播放时长" prop="seconds">
            <el-input v-model="basicData.seconds" :value="basicData.seconds" class="title-input" style=" border:0px;"></el-input>
        </el-form-item> -->
    ...
    data () {
      return {
        ...
        playerOptions : {
          ...
          notSupportedMessage: '请上传视频', //允许覆盖Video.js无法播放媒体源时显示的默认信息。
          controlBar: {
            timeDivider: true,
    ...
    methods: {
      ...
      dataFormSubmit () {
        ...
        if(valid){     
          ...
          var thiz = this;
          this.$http({
            url: this.$http.adornUrl('/smallLongHealth/video/add'),
            method: 'post',
            data: {
