...
import AddModules from "./robotBasicAdd";
import UpdateModules from "./robotBasicUpdate";
...
export default {
  ...
  methods: {
        ...
        .then(() => {
          this.$http({
            url: this.$http.adornUrl(
              "/smallVientianeTest/robotBasicInfo/delete"
            ),
            method: "get",
    ...
    getDataList(type) {
      ...
      this.$http({
        url: this.$http.adornUrl(
          "/smallVientianeTest/robotBasicInfo/getPageList"
        ),
        method: "get",
        params: this.$http.adornParams({
          type: this.type,
