...
import com.example.vientianetest.web.WebSocketRankHandler;
...
public class WebSocketRankConfiguration extends AbstractSessionWebSocketMessageBrokerConfigurer implements WebSocketConfigurer {
    @Value("${env}")
    private String env;
    ...
    public void registerWebSocketHandlers(WebSocketHandlerRegistry registry) {
        WebSocketHandlerRegistration registration =registry.addHandler(myRankHandler(), "/vientianetest/wsRank").
    ...
    @Bean
    public WebSocketRankHandler myRankHandler()
    {
        return new WebSocketRankHandler();
    }
}
